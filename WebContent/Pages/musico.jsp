                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <div class="form-group">
                        <label for="txtNomeArtistico">Nome Artístico</label>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="txtTempoExperiencia">Tempo de experiência</label>
                            <input type="text" name="txtTempoExperiencia" id="txtTempoExperiencia" class="form-control "
                              placeholder="Digite seu tempo de experiência">
                          </div>
                        </div>
                        <div class="col-md-7">
                          <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 ">
                      <div class="form-group">
                        ...
                        <input id="txtNumero" name="txtNumero" type="number" class="form-control" placeholder="Digite o número">
                      </div>
                    </div>
                  </div>
                  <div class="row">
